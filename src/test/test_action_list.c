...
void test_action_list_two_old_actions_executed(sem_dynamic_array* heap, const void* data);
void test_action_list_does_not_execute_future_action(sem_dynamic_array* heap, const void* data);
void test_action_list_does_nothing_for_empty_list(sem_dynamic_array* heap, const void* data);

int test_action(sem_dynamic_array* heap, sem_action* action);
