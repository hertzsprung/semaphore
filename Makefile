...
COMPONENTS := sem_action sem_action_list sem_compass sem_dynamic_array sem_error sem_game sem_heap sem_input sem_render sem_serialize sem_serialize_actions sem_serialize_railpro sem_revenue sem_signal sem_strings sem_parser sem_portal sem_timer sem_track_cache sem_train sem_world
