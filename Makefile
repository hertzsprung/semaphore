...
COMPONENTS := semaphore sem_action sem_action_list sem_compass sem_dynamic_array sem_error sem_heap sem_input sem_render sem_serialize sem_strings sem_timer sem_train sem_world
